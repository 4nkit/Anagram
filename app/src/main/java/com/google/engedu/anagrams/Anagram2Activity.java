...
public class Anagram2Activity extends AppCompatActivity {
    ...
    private Anagram2Dictionary dictionary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity2anagrams);
        ...
        try {
            ...
            dictionary = new Anagram2Dictionary(inputStream);
        } catch (IOException e) {
